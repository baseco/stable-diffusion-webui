...
parser.add_argument("--ckpt1", type=normalized_filepath, default=None, help="path to the second checkpoint of stable diffusion model",)
parser.add_argument("--ckpt2", type=normalized_filepath, default=None, help="path to the third checkpoint of stable diffusion model",)
